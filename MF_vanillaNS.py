...
class MF_vanillaNS:
    ...
    def train(self, train_array, epoch, bs, verbose=False):
        NS_start_time = time.time() * 1000.0
        epoch_cost = 0.
        epoch_cost1 = 0.
        epoch_cost2 = 0.
        user_list, item_list, label_list, prop_list = utility.negative_sampling_vanilla(self.num_user, self.num_item,
                                                                                train_array, self.neg)
