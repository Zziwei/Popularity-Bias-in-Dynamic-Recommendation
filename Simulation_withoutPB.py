...
class Simulation:
    ...
    def initial_iterations(self):
        ...
        if self.record:
            np.save('./Data/' + self.data + '/Experiment_withoutPB/init_click_mat.npy', init_click_mat)
    ...
    def run_simulation(self):
        ...
        if self.record:
            np.save('./Data/' + self.data + '/Experiment_withoutPB/itr_user.npy', np.array(itr_user))
            np.save('./Data/' + self.data + '/Experiment_withoutPB/itr_rec_item.npy', np.array(itr_rec_item))
            np.save('./Data/' + self.data + '/Experiment_withoutPB/itr_click_item.npy', np.array(itr_click_item, dtype=object))
