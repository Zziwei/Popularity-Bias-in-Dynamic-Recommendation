...
for r in range(args.run):
    ...
    # np.save('./Data/' + args.data + '/Experiment_vanillaNS/itr_cumulated_click_count_mean.npy', np.array(itr_cumulated_click_count_mean))
    # np.save('./Data/' + args.data + '/Experiment_vanillaNS/itr_cumulated_click_count_std.npy', np.array(itr_cumulated_click_count_std))
    # np.save('./Data/' + args.data + '/Experiment_vanillaNS/itr_GC_TPR_mean.npy', np.array(itr_GC_TPR_mean))
    # np.save('./Data/' + args.data + '/Experiment_vanillaNS/itr_GC_TPR_std.npy', np.array(itr_GC_TPR_std))
